...
It's hard to see with that test case because it's so big. But consider a modified version of the first example they gave in the description: [-100,10], [1,2], [2,3], [3,4]
if you order it by start time, as shown above then you will end up getting rid of 3 intervals ([1,2],[2,3],[3,4]) because 1,2,3 are all < 10. But if you order by increasing end time, you get [1,2],[2,3],[3,4],[-100,10] and you would only get rid of [-100,10]. Since we are going through the array from left to right, if there is a really small start time on an interval and a large end time, it could span multiple other intervals
*/
